# Last Price E05 — Independent Trade-Formation and Welfare Replication

## Status
Preregistered before execution on 2026-08-11.

## Relationship to E04
E05 is a new independent replication of the complete E04 scientific design. It is not a completion, repair, or selective rerun of any prior experiment.

No prior outcome statistic is used to tune E05. E05 keeps the same scientific design, action menus, buyer and seller models, products, primary outcomes, hypothesis tests, familywise correction, technical gate, execution reliability settings, and interpretation boundary as E04.

The only experiment-level changes are fresh E05 identifiers and a fresh deterministic seed namespace.
...
Buyer values, budgets, and reference prices are inherited unchanged from the E02/E03/E04 series.

## Finite feasible action mechanism
E05 uses the identical E04 finite-action mechanism.
...
- maximum 6 jobs in parallel;
- model downloads may be retried up to 5 times with deterministic increasing sleeps before inference begins;
- setup status is written to the cell artifact directory before model pulls;
- once episode generation begins, there are no episode retries, substitutions, repairs, or reruns.
